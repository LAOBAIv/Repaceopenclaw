...
import wechatInboundRoutes from './wechatInbound';
import wechatIncomingRoutes from './wechatIncoming';
...
{ path: '/wechat-clawbot', router: wechatClawBotRoutes },
  { path: '/wechat', router: wechatInboundRoutes },
  { path: '/wechat', router: wechatIncomingRoutes },
];
