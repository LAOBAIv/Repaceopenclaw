/**
 * SessionAgentBar 多智能体会话 Agent 栏组件
...
import { getTagColor, loadSessionTags } from './utils';
import type { SessionAgentBarProps, WechatBinding, ModelOption } from './types';
