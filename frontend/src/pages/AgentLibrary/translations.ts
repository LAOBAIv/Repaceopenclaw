/**
 * translations.ts - AgentLibrary 翻译字典
 *
 * 包含：模板描述中文翻译 (TEMPLATE_DESC_CN)、vibe 中文翻译 (VIBE_CN)。
 * 模板名称映射统一使用 constants/templateConstants.ts 中的 TEMPLATE_NAME_CN。
 * 这些字典数据量大，单独拆分以保持 constants.ts 精简。
 */

// ==================== 描述中文翻译 ====================

export const TEMPLATE_DESC_CN: Record<string, string> = {
...
export const VIBE_CN: Record<string, string> = {
